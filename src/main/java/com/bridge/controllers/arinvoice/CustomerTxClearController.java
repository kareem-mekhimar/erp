...
@Named
@ViewScoped
public class CustomerTxClearController implements Serializable{
    ...
    public void filter()
    {
       transactions = bankTxService.findRecieveByBankAccountId(currentBankAccount.getBankAccountId()) ;
    }
    ...
    public void clearTransactions()
    {
       ...
       bankTxService.clear(transactions,date,currentOperatingUnit, currentBankAccount,PaymentTxType.RECIEVE);

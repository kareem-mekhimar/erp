...
@Model
public class SystemItemConverter implements Converter{
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        return systemItemService.findById(Integer.parseInt(value)) ;
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        return String.valueOf(((SystemItem) value).getInventoryItemId()) ;
    }

 ...
 */
package com.bridge.entities.arinvoice.payment;
 ...
 */
@Entity
@Table(name = "AR_INVOICE_PAYMENTS")
@NamedQueries({
    @NamedQuery(name = "ArInvoicePayment.findAll", query = "SELECT a FROM ArInvoicePayment a")})
public class ArInvoicePayment implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "arinvoicepay")
    @TableGenerator(name = "arinvoicepay", table = "SYSTEM_SEQUENCES_GENERATOR", allocationSize = 20,
             pkColumnName = "SEQUENCE_NAME", pkColumnValue = "ArInvoicePayment", valueColumnName = "CURRENT_VALUE")
    ...
    public ArInvoicePayment() {
    }

    public ArInvoicePayment(ArInvoice invoice)
    {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ArInvoicePayment)) {
            return false;
        }
        ArInvoicePayment other = (ArInvoicePayment) object;
    ...
    public String toString() {
        return "com.bridge.entities.invoice.payment.ArInvoicePayment[ paymentId=" + paymentId + " ]";
    }

...
public class UserNotification implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE,generator = "usernotifi")
    @TableGenerator(name = "usernotifi",table = "SYSTEM_SEQUENCES_GENERATOR",allocationSize = 20
            ,pkColumnName = "SEQUENCE_NAME",pkColumnValue = "UserNotification",valueColumnName = "CURRENT_VALUE")
    @Column(name = "ID")
    private Integer id;
    ...
    public UserNotification(Integer userId, String description) {
    ...
    public String toString() {
        return "com.bridge.entities.hr.UserNotification[ id=" + id + " ]";
    }
